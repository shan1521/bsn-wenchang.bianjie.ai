---
{
    ...
    <li>（1）用户须通过充值，确保账户中有充足的人民币余额，具体流程请参阅以下文档：
        [https://www.bsnbase.com/static/tmpFile/bzsc/Account/13-1.html](https://www.bsnbase.com/static/tmpFile/bzsc/Account/13-1.html)</li>
    <li>（2）再由批量充值接口，将能量值充至指定链账户，具体流程请参阅以下 BSN 批量充值能量值接口文档：
        [https://shimo.im/docs/Ee32M5ZXd0H44pA2](https://shimo.im/docs/Ee32M5ZXd0H44pA2) </li>
